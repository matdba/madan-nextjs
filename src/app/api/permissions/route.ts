...
import { PermissionListSchema } from '@/lib/schemas/permission-list.schema';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const raw = await backendFetch('/Permissions/list', {
      method: 'GET',
    ...
    const result = PermissionListSchema.parse(raw);
