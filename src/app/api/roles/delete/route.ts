...
import { DeleteRoleRequestSchema } from '@/lib/schemas/role-list.schema';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const data = DeleteRoleRequestSchema.parse(body);

    const raw = await backendFetch('/Roles/delete', {
      method: 'POST',
