...
import { ActivityTypeListSchema } from '@/lib/schemas/activity-type.schema';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const raw = await backendFetch('/activity-types/list', {
      method: 'GET',
    ...
    const result = ActivityTypeListSchema.parse(raw);
