...
import { DeleteUserRequestSchema } from '@/lib/schemas/user-list.schema';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const data = DeleteUserRequestSchema.parse(body);

    const raw = await backendFetch('/Users/delete', {
      method: 'POST',
